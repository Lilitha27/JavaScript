...
var newStudent1 ={name: "Lilitha", grade: 12, phone: "560066849861", year: 3, active: false};

//Object 2 - Name the variable newStudent2 and set its active property to true

var newStudent2 ={name: "Sinovuyo", grade: 11, phone: "560066849861", year: 4,active: true};
...
student_data.push(newStudent1, newStudent2)
...
function addStudent(studentName){
  ...
  if(studentArrayIndex === -1){
    active_students.push(studentName);
    console.log(active_students)
  } else{
...
function removeStudent(studentName){
  ...
  //   active_students.splice(student_data[].name);
  //     }
  // }
  // removeStudent()
    ...
    for(i = 0; i < student_data.length; i++){
        ...
        if(student_data[i].name === studentName){
          ...
          //DO ACTIVITY 2 HERE
          student_data[i].active = false
          active_students.splice(studentArrayIndex,1)
                }
    }
...
function changeNumber(name, phone ){
